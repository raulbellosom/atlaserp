...
- [x] F1-B Role-post navigation: manifest nav replaced with Caja/Comandero/Cocina/Ordenes/Administracion, `PosHomeRedirect` permission landing, wrapper screens over existing UIs, legacy routes preserved, outlet flags editor in Administración
