...
function usage() {
  console.log(
    [
      ...
      '',
      'Examples:',
      '  node scripts/check-module-manifest-migrations.mjs modules/official/atlas.fleet',
      '  node scripts/check-module-manifest-migrations.mjs modules/official/atlas.fleet --write',
      '',
      'Status:',
      '  OK  — checksum matches',
