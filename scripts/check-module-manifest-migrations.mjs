...
function usage() {
  console.log(
    [
      ...
      '',
      'Examples:',
      '  node scripts/check-module-manifest-migrations.mjs modules/official/runly.fleet',
      '  node scripts/check-module-manifest-migrations.mjs modules/official/runly.fleet --write',
      '',
      'Status:',
      '  OK  — checksum matches',
