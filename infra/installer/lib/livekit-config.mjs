...
export function renderExternalProxyGuide({ domain }) {
  return [
    "# Generated by Atlas ERP. Install this server block in the host reverse proxy.",
    "# Replace the certificate paths with the trusted certificate for LIVEKIT_DOMAIN.",
    "server {",
