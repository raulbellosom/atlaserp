# Runly ERP v2 — GitHub Copilot Instructions

## Module system

ERP features live under `modules/custom/<moduleKey>/` as self-contained **RME3 modules**.
Full guide with code examples: `docs/ai-context/rme3-modules.md` — read it before
...
- **Do NOT use `prisma.<model>` for RME3 tables** — use `prisma.$queryRaw` tagged templates
...
`modules/custom/custom.fleet/` — canonical RME3 module example.
