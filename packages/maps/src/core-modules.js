...
export const atlasCoreMap = createModuleManifest({
  ...
  acl: {
    ...
    actions: {
      ...
      "modules.install": "core.modules.create",
      "modules.disable": "core.modules.update",
      "modules.enable": "core.modules.update",
      "modules.uninstall": "core.modules.delete",
...
export const identityMap = createModuleManifest({
  ...
  acl: {
    ...
    actions: {
      ...
      "identity.roles.manage": "identity.roles.update",
      ...
      "identity.permissions.manage": "identity.permissions.update",
...
export const filesMap = createModuleManifest({
  ...
  acl: {
    ...
    actions: {
      ...
      "files.upload": "files.assets.create",
