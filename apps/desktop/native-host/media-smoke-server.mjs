...
createServer(async (req, res) => {
  ...
  res.end(`<!doctype html><meta name="viewport" content="width=device-width"><h1>Runly: prueba local de pantalla</h1><pre id="status"></pre><script src="/app/livekit.js"></script><script>
