...
// Auto-import all RME3 custom module manifests bundled with the desktop app.
...
const _rme3ModuleFiles = import.meta.glob(
  "../../../../modules/custom/*/module.manifest.js",
  { eager: true },
);
const _rme3Manifests = Object.values(_rme3ModuleFiles)
  .map((mod) => mod?.default ?? null)
  .filter((m) => m && typeof m === "object" && m.key);

export function mergeRuntimeModules(rawApiModules, options = {}) {
  return mergeModules(rawApiModules, { ...options, manifests: _rme3Manifests });
}
