...
export default function ReportFormPage() {
  ...
  const handleNavigate = useCallback(({ mode: nextMode }) => {
    ...
    if (nextMode === 'detail' && recordId) {
      navigate(`/app/m/runly.fleet/reports/${recordId}`, { replace: true })
    }
