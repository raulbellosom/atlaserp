...
export function useProductModifierGroups(productId, { includeDisabled = false } = {}) {
  ...
  return useQuery({
    ...
    queryFn: () => runly.pos.listProductModifierGroups(productId, includeDisabled ? { includeDisabled: true } : {}, token),
...
export function useModifierGroupsByProducts(productIds = []) {
  ...
  return useQuery({
    ...
    queryFn: () => runly.pos.listModifierGroups({ productIds: key }, token),
    select: (res) => res?.data ?? res,
...
export function useCreateModifierGroup() {
  ...
  return useMutation({
    mutationFn: ({ productId, data }) => runly.pos.createModifierGroup(productId, data, token),
...
export function useUpdateModifierGroup() {
  ...
  const invalidate = useInvalidateModifiers()
  return useMutation({
    mutationFn: ({ id, data }) => runly.pos.updateModifierGroup(id, data, token),
...
export function useCreateModifierOption() {
  ...
  const invalidate = useInvalidateModifiers()
  return useMutation({
    mutationFn: ({ groupId, data }) => runly.pos.createModifierOption(groupId, data, token),
...
export function useUpdateModifierOption() {
  ...
  const invalidate = useInvalidateModifiers()
  return useMutation({
    mutationFn: ({ id, data }) => runly.pos.updateModifierOption(id, data, token),
