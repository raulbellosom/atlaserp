    ...
    sections: [
      {
        ...
        collapsible: true,
        fields: [
          { field: 'plate', label: 'Matricula', type: 'text', required: true, hint: 'Placa oficial de circulacion (ej. ABC-1234)' },
          {
          ...
          { field: 'color', label: 'Color del vehiculo', type: 'color', hint: 'Color exterior principal del vehiculo' },
          {
            field: 'status',
          ...
          { field: 'economic_individual_number', label: 'No. Economico individual', type: 'text', hint: 'Numero de unidad asignado internamente (ej. 042)' },
        ],
      },
      {
