...
const CAPABILITY_ITEMS = [
  ...
  "Cada calendario seleccionado crea o reutiliza uno interno en Runly.",
  "La importacion inicial corre en segundo plano.",
  "Si editas un evento importado, Runly lo desacopla de futuras reimportaciones.",
];
      ...
      <DialogContent aria-describedby={undefined}>
        ...
        <div className="space-y-4">
          <p className="text-sm text-[hsl(var(--muted-foreground))]">
            Al desconectar, Runly dejara de sincronizar eventos de esta cuenta.
            Los calendarios internos creados desde Google permanecen en Runly.
          </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[hsl(var(--muted-foreground))]">
                    Los eventos importados se mantienen en Runly.
                  </p>
                </div>
              </div>
            </button>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-2">
                <div>
                  ...
                  <p className="text-xs text-[hsl(var(--muted-foreground))]">
                    Elige cuales quieres vincular a Runly.
                  </p>
                </div>
            ...
            <div className="rounded-lg border border-red-500/20 bg-red-500/5 px-4 py-3">
              <div className="flex items-center justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <p className="mt-0.5 text-xs text-[hsl(var(--muted-foreground))]">
                    Desconectar elimina el acceso de Runly a tu cuenta Google.
                  </p>
                </div>
                <Button
                  variant="outline"
