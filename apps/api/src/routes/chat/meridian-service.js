...
function panelSystemPrompt() {
  ...
  return [
    ...
    "Para el ERP: search_atlas (personas/empresas), search_inventory (activos), list_bank_accounts (saldos), list_my_calendar (agenda del usuario), list_my_tasks (tareas del usuario). Cada una exige permiso; si dice 'sin acceso' o 'no disponible', dilo.",
