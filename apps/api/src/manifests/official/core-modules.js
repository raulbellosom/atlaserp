...
export const atlasFleetManifest = createModuleManifest({
  ...
  core: true,
  uninstallable: false,
  description: "Gestion de flota vehicular: vehiculos, reportes y asignacion de conductores.",
  ...
  navigation: [
    ...
    },
    {
      ...
      children: [
        { label: "Mantenimiento", path: "/app/m/atlas.fleet/reports/maintenance", permissionKey: "fleet.reports.read" },
        { label: "Servicio", path: "/app/m/atlas.fleet/reports/service", permissionKey: "fleet.reports.read" },
        { label: "Reparacion", path: "/app/m/atlas.fleet/reports/repair", permissionKey: "fleet.reports.read" },
      ],
    },
    {
      label: "Choferes",
    ...
    },
    {
      ...
      children: [
        { label: "Tipos de vehiculo", path: "/app/m/atlas.fleet/catalogs/vehicle-types", permissionKey: "fleet.catalogs.read" },
        { label: "Marcas", path: "/app/m/atlas.fleet/catalogs/vehicle-brands", permissionKey: "fleet.catalogs.read" },
        { label: "Modelos", path: "/app/m/atlas.fleet/catalogs/vehicle-models", permissionKey: "fleet.catalogs.read" },
      ],
    },
  ],
});
