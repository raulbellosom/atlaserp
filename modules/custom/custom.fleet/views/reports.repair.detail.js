    ...
    sections: [
      {
        ...
        fields: [
          ...
          { field: "repair_priority", label: "Prioridad", icon: "Tag" },
          { field: "repair_damage_type", label: "Tipo de dano", icon: "Wrench" },
      ...
      },
      {
        ...
        columns: 2,
        fields: [
          { field: "repair_estimated_cost", label: "Estimado", type: "number", icon: "Tag" },
